...
import { analyzeItems } from '../extension/src/core.mjs';
const root = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');

const product = {
  "repo": "prepost-page-annotation-workflow",
  ...
  "implFiles": [
    "extension/src/core.mjs",
    "extension/src/validators.mjs",
    "extension/src/report.mjs",
