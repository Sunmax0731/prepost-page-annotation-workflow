...
- 必須項目 `url`, `checklist`, `annotation`, `status` の不足を検出する。
...
参照元 ZIP: `D:\AI\ChromeExtension\created_idea_004_prepost-page-annotation-workflow\idea_004_prepost-page-annotation-workflow.zip`。一部に文字化けがあったため、正式docsは `PICKUP_100_IDEAS.md` とドメインガイドから再構成した。
