...
| --- | --- | --- | --- | --- | --- |
| QFR-001 | 必須項目不足を検出する | extension/src/core.mjs<br>extension/src/validators.mjs<br>extension/src/report.mjs<br>extension/popup.html<br>extension/manifest.json | tests/core.test.mjs<br>tests/review-model.test.mjs<br>tests/representative-suite.test.mjs | docs/user-guide.md | docs/release-checklist.md |
